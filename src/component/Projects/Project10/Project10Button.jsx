...
const Project10Button = ({ imageUrl }) => {
      ...
      {isHovered && (
        <div>
          ...
          <div className="absolute top-28 left-8  flex items-center justify-center">
            <a
              target="_blank"
              href="https://github.com/arshadrahman02/assignment-legal"
            >
            ...
            <a target="_blank" href="https://legal-notice.netlify.app/">
...
export default Project10Button;

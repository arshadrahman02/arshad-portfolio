      ...
      {isHovered && (
        <div>
          ...
          <div className="absolute top-28 left-8  flex items-center justify-center">
            <a
              target="_blank"
              href="https://github.com/arshadrahman02/temperature-hot"
            >
            ...
            <a
              target="_blank"
              href="https://arshadrahman02.github.io/temperature-hot/"
            >
